...
[Ссылка на презентацию](https://docs.google.com/presentation/d/1UYF8mV91KTrlks6uVCAvheOVByFUCfo5EWCzQ49Ia0k/edit?slide=id.g32c9a3daff5_1_2#slide=id.g32c9a3daff5_1_2)
...
- Сделать аналитические витрины с использованием DBT и как минимум двух видов инкрементальной
  загрузки.
- Использовать теги или префиксы или схемы для разделения моделей по функциональности. STG - ODS -
  DWH / DM.
...
- Обновляемая аналитическая витрина в PostgreSQL – credentials на подключение и указание, в какие
  витрины смотреть.
